...
export function Header() {
  ...
  return (
    <header className={`w-full h-16 flex items-center justify-center gap-32 max-lg:gap-2 px-2 bg-zinc-50 border-b border-solid border-zinc-200 max-lg:justify-between text-black ${mobileMenu && 'fixed'} z-50`}>
      <Link href={"/"}>
      ...
      <ul
        className={`w-full left-0 h-[calc(100vh-63.99px)] fixed top-16 bg-zinc-50 hidden ${
          mobileMenu &&
