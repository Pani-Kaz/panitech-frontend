...
export function Footer() {
  return (
    <footer className="w-full p-4 py-8 px-[15%] max-lg:px-4  bg-black text-white">
      <div className="flex justify-between max-lg:flex-col items-start gap-20">
      ...
      <div className="w-full flex items-center justify-start mt-5 py-5 border-t border-solid border-zinc-700">
        <p className="text-xs font-semibold">
        Pani Tech 2023-2024 © CNPJ 54.384.413/0001-46
        </p>
      </div>
    </footer>
  );
